...
def add_user_to_session(user, session_id, added_user_id):
    try:
        controllers.add_user_to_session(user, session_id, added_user_id)
...
def get_session_users(user, session_id):
    '''
    Returns all users in given session_id that the user is a part of
    '''
    try:
        users = controllers.get_session_users(user, session_id)
